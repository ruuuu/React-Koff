...
import { fetchСategories } from "../../store/categories/categories.slice";
...
export const Main = () => {
  ...
  const { data: dataCategories, loading: loadingCategories, error: errorCategories } = useSelector((state)=> state.categories);  // задает доступ к state = {data, loading, erroor}, переименовали data в dataCategories, loading в  loadingCategories
